        ...
        "whitepapers": [
            {
                ...
                "description": "Examines how HeroForge's innovative colored teams architecture addresses critical gaps in the current cybersecurity landscape."
            },
            {
                "id": "novel-approach",
                "title": "Breaking the Mold: HeroForge's Novel Approach to Enterprise Cybersecurity",
                "description": "Explores how unified security operations delivers capabilities beyond traditional enterprise toolsets."
            }
        ]
    })))
}
