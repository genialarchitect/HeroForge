...
pub async fn run_web_server(database_url: &str, bind_address: &str) -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        ...
        App::new()
            ...
            .service(
                web::scope("/api/badges")
                    .wrap(rate_limit::RateLimitStatsMiddleware::api())
                    .wrap(rate_limit::api_rate_limiter())
                    .route("/{domain}", web::get().to(api::badges::get_badge))
                    .route("/{domain}/score", web::get().to(api::badges::get_score))
            ...
            .service(
                web::scope("/api")
                    ...
                    // IDS (Intrusion Detection System) rule management endpoints
                    ...
                    // Binary Analysis (Sprint 3 - Priority 1 Features) endpoints
