...
const whitepapers: Whitepaper[] = [
  {
    ...
    description: 'Examines how HeroForge\'s innovative "colored teams" architecture addresses critical gaps in the current cybersecurity landscape and positions organizations for success against evolving threats.',
    readTime: '15 min read',
    date: 'January 2025',
    topics: ['Unified Security', 'Colored Teams', 'Enterprise Architecture', 'Security Operations'],
  },
  {
    id: 'novel-approach',
    title: 'Breaking the Mold',
    subtitle: 'HeroForge\'s Novel Approach to Enterprise Cybersecurity',
    description: 'Explores how unified security operations delivers capabilities beyond traditional enterprise toolsets, including unique use cases that are unavailable in fragmented security stacks.',
    readTime: '20 min read',
    date: 'January 2025',
    topics: ['Innovation', 'Offense-Defense Loop', 'Exploitation Validation', 'Emerging Domains'],
  },
];
